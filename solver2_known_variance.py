        ...
        for j in self.set_candidate:
            if self.mu_hat_curr[j] >= self.mu_hat_curr[i]:
                ...
                ll -= -(self.sample_sqtot_n0[j] - 2 * self.sample_total_n0[j] * self.mu_hat_curr[j] +
                        self.sample_count_n0[j] * self.mu_hat_curr[j] ** 2) / self.lst_std[j] ** 2 / 2
                ll += -(self.sample_sqtot_n0[j] - 2 * self.sample_total_n0[j] * mu_tmp +
                        self.sample_count_n0[j] * mu_tmp ** 2) / self.lst_std[j] ** 2 / 2
